...
import "./SignalArcAgentMarket.sol";
...
contract SignalArcAgentMarketFactory {
    ...
    function createMarket(
        ...
        market = address(new SignalArcAgentMarket(question, closeTimestamp, msg.sender, resolver, collateralToken));
        marketById[marketId] = market;
        isMarket[market] = true;
        allMarkets.push(market);

        emit AgentMarketDeployed(marketId, market, msg.sender, resolver, collateralToken, closeTimestamp, question);
    }
